...
VDControllerApp::VDControllerApp() : mSpoutOut("VDCTRL", app::getWindowSize())
{

	// Settings
	mVDSettings = VDSettings::create("VDCTRL");
	// Uniform
...
void VDControllerApp::draw()
{
	...
	getWindow()->setTitle(toString((int)getAverageFps()) + " fps VDCTRL");
}
void prepareSettings(App::Settings *settings)
{
	settings->setWindowSize(1280, 720);
}
CINDER_APP(VDControllerApp, RendererGl(RendererGl::Options().msaa(8)),  prepareSettings)
